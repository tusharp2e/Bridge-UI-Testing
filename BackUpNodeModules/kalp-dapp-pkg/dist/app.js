...
__export(app_exports, {
  ...
  getEnrollmentIdFromWallet: () => getEnrollmentIdFromWallet,
  getToken: () => getToken,
  reEngageEvents: () => reEngageEvents,
  readTransactionFromWallet: () => readTransactionFromWallet,
  writeTransactionFromWallet: () => writeTransactionFromWallet
});
...
var getEnrollmentId = async (dappToken, dappName, dappURL, dappIcon) => {
  const methodCallId = (0, import_uuid.v4)();
